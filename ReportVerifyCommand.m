...
classdef ReportVerifyCommand
    %ReportVerifyCommand Conversion of CR_rept_verify.m
    ...
    methods
        %examine variable
        function [obj] = reportVerifyCommand(obj)
            
        end
        function [obj] = reportverify(obj)
