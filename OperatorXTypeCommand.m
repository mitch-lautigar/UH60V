...
classdef OperatorXTypeCommand
    %OperatorXTypeCommand Conversion of CR_operatorXType.m
    ...
    methods
        %examine variable
        function [outputStr, errorFlag] = operatorXTypeCommand(obj, varargin)
           if ~isequal(nargin,2)
            ...
            if ~exist('showDialogs','var') || showDialogs==1
                modalType = variableTwo;
                outputStr = sprintf('OperatorXType Command Success.');
            end
           end
        end
    end
