...
classdef OperatorXCommand
    %OperatorXCommand Conversion of CR_operatorX.m
    ...
    methods
        %examine variable
        function [outputStr, errorFlag] = operatorXCommand(obj, varargin)
          if ~isequal(nargin,2)
            ...
            if ~exist('showDialogs','var') || showDialogs==1
                modalTitle = variableTwo;
                modalDlg = {};
                modalType = 'Operator';
                outputStr = sprintf('OperatorXCommand success.');
            end
          end
        end
    end
