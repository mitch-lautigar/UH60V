...
classdef ReportNoteCommand
    %ReportNoteCommand Conversion of CR_rept_note.m
    ...
    methods
        %examine variable
        function [outputStr, errorFlag] = reportNoteCommand(obj, varargin)
          if ~isequal(nargin,5)
            ...
            try %#ok<TRYNC>
               if handles.speak
                   ...
                   outputStr = sprintf('Report Note Command Completed Successfully');
               end
            end          
          end
        end
